...
/* Used by ISR to signal that the LCD VSync is ready */
volatile bool g_display_vsync_ready = false;
...
void graphics_end_frame(void)
{
    ...
    /* Wait for DRW hardware to finish rendering */
