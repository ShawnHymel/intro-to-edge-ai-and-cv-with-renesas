...
py::object wrapper(
  ...
  py::array_t<float, py::array::c_style> output_0 ({ 1,5 });
  
  
  const py::ssize_t expected_in_shape_0[] = { 1,5 };
  
  
  const py::ssize_t expected_out_shape_0[] = { 1,5 };
...
PYBIND11_MODULE(py_compute, m) {
  ...
  m.def("compute", &wrapper,
    ...
    "Generated compute_sub_0002 function"
  );
