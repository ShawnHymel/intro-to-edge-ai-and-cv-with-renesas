...
__attribute__((aligned(16))) uint8_t sub_0001_arena[672];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0001_fast_scratch[672];
...
int sub_0001_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0001_model with size 40080 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0001_model_data;
  base_addrs_size[0] = sub_0001_model_data_size;
  // Buffer sub_0001_arena with size 672 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0001_arena+0);
  base_addrs_size[1] = 672;

  // Buffer sub_0001_fast_scratch with size 672 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0001_arena+0);
  base_addrs_size[2] = 672;

  // Buffer input_tensor_0 with size 600 and address: 0
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0001_arena+0);
  base_addrs_size[3] = 600;

  // Buffer output_tensor_0 with size 5 and address: 32
  if (clean_outputs) {
    memset(sub_0001_arena + 32, 0, 5);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0001_arena+32);
  base_addrs_size[4] = 5;
