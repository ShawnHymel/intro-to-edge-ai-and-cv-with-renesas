...
#define VECTOR_NUMBER_SCI8_ERI ((IRQn_Type) 1) /* SCI8 ERI (Receive error) */
#define SCI8_ERI_IRQn          ((IRQn_Type) 1) /* SCI8 ERI (Receive error) */
#define VECTOR_NUMBER_SCI8_RXI ((IRQn_Type) 2) /* SCI8 RXI (Receive data full) */
#define SCI8_RXI_IRQn          ((IRQn_Type) 2) /* SCI8 RXI (Receive data full) */
