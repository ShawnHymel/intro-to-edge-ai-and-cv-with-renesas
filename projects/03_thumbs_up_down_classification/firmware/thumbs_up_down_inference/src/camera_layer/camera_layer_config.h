...
#define CAMERA_ACTIVE_IMAGE_WIDTH    (640) // Raw camera capture image width in pixel (VGA)
#define CAMERA_ACTIVE_IMAGE_HEIGHT   (480) // Raw camera capture image height in pixel (VGA)
...
// ------------------ Buffer allocation ------------------
// Buffer placement: 0 = On-chip RAM, 1 = SDRAM
#define ALLOCATE_TO_ONCHIP_RAM  (0)
#define ALLOCATE_TO_SDRAM       (1)

#define CAMERA_CAPTURE_BUFFER_ALLOCATION  ALLOCATE_TO_SDRAM
#define CAMERA_IMAGE_ALLOCATION           ALLOCATE_TO_ONCHIP_RAM  // DRW needs to read from internal RAM
