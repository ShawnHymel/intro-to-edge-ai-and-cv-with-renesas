...
#define VECTOR_NUMBER_MIPICSI_DL ((IRQn_Type) 14) /* MIPICSI DL (Data Lane interrupt) */
#define MIPICSI_DL_IRQn          ((IRQn_Type) 14) /* MIPICSI DL (Data Lane interrupt) */
#define VECTOR_NUMBER_MIPICSI_GST ((IRQn_Type) 15) /* MIPICSI GST (Generic Short Packet interrupt) */
#define MIPICSI_GST_IRQn          ((IRQn_Type) 15) /* MIPICSI GST (Generic Short Packet interrupt) */
...
#define VECTOR_NUMBER_VIN_ERR ((IRQn_Type) 19) /* VIN ERR (Interrupt Request for SYNC Error) */
#define VIN_ERR_IRQn          ((IRQn_Type) 19) /* VIN ERR (Interrupt Request for SYNC Error) */
#define VECTOR_NUMBER_VIN_IRQ ((IRQn_Type) 20) /* VIN IRQ (Interrupt Request) */
#define VIN_IRQ_IRQn          ((IRQn_Type) 20) /* VIN IRQ (Interrupt Request) */
