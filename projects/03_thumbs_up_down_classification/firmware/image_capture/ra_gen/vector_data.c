...
/* Do not build these data structures if no interrupts are currently allocated because IAR will have build errors. */
        ...
        BSP_DONT_REMOVE const fsp_vector_t g_vector_table[BSP_ICU_VECTOR_NUM_ENTRIES] BSP_PLACE_IN_SECTION(BSP_SECTION_APPLICATION_VECTORS) =
        {
            ...
            [14] = mipi_csi_dl_isr, /* MIPICSI DL (Data Lane interrupt) */
            ...
            [19] = vin_err_isr, /* VIN ERR (Interrupt Request for SYNC Error) */
            [20] = vin_irq_isr, /* VIN IRQ (Interrupt Request) */
        };
        ...
        const bsp_interrupt_event_t g_interrupt_event_link_select[BSP_ICU_VECTOR_NUM_ENTRIES] =
        {
            ...
            [14] = BSP_PRV_VECT_ENUM(EVENT_MIPICSI_DL,GROUP6), /* MIPICSI DL (Data Lane interrupt) */
            ...
            [19] = BSP_PRV_VECT_ENUM(EVENT_VIN_ERR,GROUP3), /* VIN ERR (Interrupt Request for SYNC Error) */
            [20] = BSP_PRV_VECT_ENUM(EVENT_VIN_IRQ,GROUP4), /* VIN IRQ (Interrupt Request) */
        };
        #endif
        #endif
